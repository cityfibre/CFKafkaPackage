...
return [
    ...
    'ingress_retries' => (int)env('INGRESS_RETRIES', 3),
    'ingress_retry_sleep' => (int)env('INGRESS_RETRY_SLEEP', 3600),
    'topic_mapping' => [
        'topicName' => [
            'service' => 'ServiceName',
            'createUpdateMethodName' => 'CreateUpdateMethodName',
            'delete' => 'DeleteMethodName',
            'queuePriority' => 'high' // optional
        ]
    ]
];
